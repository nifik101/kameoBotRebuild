"""Tests for Kameo client functionality."""
...
@pytest.fixture
def mock_env_dict():
    """Provide test configuration values as a dictionary."""
    return {
...
def test_config_loading(mock_env_dict):
...
def test_2fa_generation(config):
...
def test_2fa_verification(config):
